# PRD Execution Prompt

This is the long-form teaching prompt that inspired `the-smoker`. Use the packaged command or skill for normal work because it follows the native format of each harness. Keep this document as a readable reference for the acceptance-ledger, wave-planning, verification, and ship-gate ideas.
