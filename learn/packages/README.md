...
|---|---|---|
| `vibe-coding-tools-claude-code-1.0.1.zip` | `.claude/` | Claude Code agents, skills, commands, rules, and hooks |
| `vibe-coding-tools-codex-1.0.1.zip` | `.codex/plugins/vibe-coding-tools/` | Codex plugin with 82 skills and hooks |
| `vibe-coding-tools-codex-project-1.0.1.zip` | Repository root | Codex project adapter with 82 repository skills, 77 TOML agents, configuration, and hooks |
| `vibe-coding-tools-cursor-1.0.1.zip` | `.cursor/` | Cursor agents, skills, commands, rules, and hooks |
