...
[`.cursor/skills/posthog-stinger/`](../skills/posthog-stinger/)

Read `.cursor/skills/posthog-stinger/SKILL.md` first - it is the master navigation layer for this Bee's arsenal (progressive-disclosure map, known research gaps, the Ship Gate).
