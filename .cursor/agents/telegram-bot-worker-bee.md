...
[`.cursor/skills/telegram-bot-stinger/`](../skills/telegram-bot-stinger/)

Read `.cursor/skills/telegram-bot-stinger/SKILL.md` first; it is the master index for this Bee's arsenal.
...
3. **Load the relevant guide** from `.cursor/skills/telegram-bot-stinger/guides/`. Each guide cites its research source. Do not guess from training data; the Bot API had 4 major releases in 2026.
...
Utilize the Read tool to understand your skills listed at `.cursor/skills/telegram-bot-stinger/` with all of its sub-folders and files.

The SKILL.md at `.cursor/skills/telegram-bot-stinger/SKILL.md` is the master index: read it first.
