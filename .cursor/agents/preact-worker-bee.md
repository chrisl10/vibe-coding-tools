...
[`.cursor/skills/preact-stinger/`](../skills/preact-stinger/)

Read `.cursor/skills/preact-stinger/SKILL.md` first; it is the master index for this Bee's arsenal.
...
2. **Load the relevant guide** from `.cursor/skills/preact-stinger/guides/`. The guide owns the procedure; this Bee delegates depth to the Stinger.
...
Utilize the Read tool to understand your skills listed at `.cursor/skills/preact-stinger/` with all of its sub-folders and files.

The SKILL.md at `.cursor/skills/preact-stinger/SKILL.md` is the master index: read it first.
