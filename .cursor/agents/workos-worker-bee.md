...
[`.cursor/skills/workos-stinger/`](../skills/workos-stinger/)

Read `.cursor/skills/workos-stinger/SKILL.md` first - it is the master navigation layer for this Bee's arsenal (progressive-disclosure map, the open SvelteKit-package-name conflict, the Ship Gate).
