...
[`.cursor/skills/tailscale-stinger/`](../skills/tailscale-stinger/)

Read `.cursor/skills/tailscale-stinger/SKILL.md` first - it is the master navigation layer for this Bee's arsenal (progressive-disclosure map, the Neon-connectivity gap, the Ship Gate).
