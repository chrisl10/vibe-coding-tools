...
[`.cursor/skills/tanstack-stinger/`](../skills/tanstack-stinger/)

Read `.cursor/skills/tanstack-stinger/SKILL.md` first - it is the master navigation layer for this Bee's arsenal (Svelte 5 support matrix, progressive-disclosure map, known gaps, the Ship Gate).
