...
[`.cursor/skills/csv-xlsx-import-export-stinger/`](../skills/csv-xlsx-import-export-stinger/)

Read `.cursor/skills/csv-xlsx-import-export-stinger/SKILL.md` first; it is the master index for this Bee's arsenal.
...
Utilize the Read tool to understand your skills listed at `.cursor/skills/csv-xlsx-import-export-stinger/` with all of its sub-folders and files.

The SKILL.md at `.cursor/skills/csv-xlsx-import-export-stinger/SKILL.md` is the master index -- read it first.
