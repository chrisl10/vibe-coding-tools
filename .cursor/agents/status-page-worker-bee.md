...
[`.cursor/skills/status-page-stinger/`](../skills/status-page-stinger/)

Read `.cursor/skills/status-page-stinger/SKILL.md` first; it is the master index for this Bee's arsenal.
...
Utilize the Read tool to understand your skills listed at `.cursor/skills/status-page-stinger/` with all of its sub-folders and files.

The SKILL.md at `.cursor/skills/status-page-stinger/SKILL.md` is the master index: read it first.
