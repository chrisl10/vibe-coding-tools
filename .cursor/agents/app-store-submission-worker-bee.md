...
[`.cursor/skills/app-store-submission-stinger/`](../skills/app-store-submission-stinger/)

Read `.cursor/skills/app-store-submission-stinger/SKILL.md` first; it is the master index for this Bee's arsenal.
...
Utilize the Read tool to understand your skills listed at `.cursor/skills/app-store-submission-stinger/` with all of its sub-folders and files.

The SKILL.md at `.cursor/skills/app-store-submission-stinger/SKILL.md` is the master index: read it first.
