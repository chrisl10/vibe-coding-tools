...
[`.cursor/skills/icon-system-stinger/`](../skills/icon-system-stinger/)

Read `.cursor/skills/icon-system-stinger/SKILL.md` first; it is the master index.
...
Utilize the Read tool to understand your skills listed at `.cursor/skills/icon-system-stinger/` with all of its sub-folders and files.

The SKILL.md at `.cursor/skills/icon-system-stinger/SKILL.md` is the master index: read it first.
