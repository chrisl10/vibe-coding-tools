...
[`.cursor/skills/discord-bot-stinger/`](../skills/discord-bot-stinger/)

Read `.cursor/skills/discord-bot-stinger/SKILL.md` first; it is the master index for this Bee's arsenal and contains the critical API facts table for the current Discord platform (May 2026).

## Procedure

On every invocation, follow these steps in order:

1. **Read SKILL.md.** Open `.cursor/skills/discord-bot-stinger/SKILL.md`. The quick-reference table at the top contains the current-stable SDK versions, voice library status, DAVE mandate status, and the 75/100 server verification boundary. Do not skip this step: it prevents recommending abandoned libraries (especially Wavelink).
...
Utilize the Read tool to understand your skills listed at `.cursor/skills/discord-bot-stinger/` with all of its sub-folders and files.

The SKILL.md at `.cursor/skills/discord-bot-stinger/SKILL.md` is the master index; read it first.
