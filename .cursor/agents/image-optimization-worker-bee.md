...
[`.cursor/skills/image-optimization-stinger/`](../skills/image-optimization-stinger/)

Read `.cursor/skills/image-optimization-stinger/SKILL.md` first; it is the master index for this Bee's arsenal.
...
Utilize the Read tool to understand your skills listed at `.cursor/skills/image-optimization-stinger/` with all of its sub-folders and files.

The SKILL.md at `.cursor/skills/image-optimization-stinger/SKILL.md` is the master index: read it first.
