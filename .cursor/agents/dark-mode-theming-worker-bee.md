...
[`.cursor/skills/dark-mode-theming-stinger/`](../skills/dark-mode-theming-stinger/)

Read `.cursor/skills/dark-mode-theming-stinger/SKILL.md` first: it is the master index and task-routing table.
...
Utilize the Read tool to understand your skills listed at `.cursor/skills/dark-mode-theming-stinger/` with all of its sub-folders and files.

The SKILL.md at `.cursor/skills/dark-mode-theming-stinger/SKILL.md` is the master index: read it first.
