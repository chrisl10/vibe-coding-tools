...
[`.claude/skills/db-stinger/`](../skills/db-stinger/)

Read `.claude/skills/db-stinger/SKILL.md` first: it is the master navigation layer for this Bee's arsenal (invocation modes, severity rubric, hard rules, cross-Bee handoffs).
...
Utilize the Read tool to understand your skills listed at `.claude/skills/db-stinger/` with all of its sub-folders and files.
