...
[`.claude/skills/retrospective-stinger/`](../skills/retrospective-stinger/)

Read `.claude/skills/retrospective-stinger/SKILL.md` first; it is the master index for this Bee's arsenal.
...
Utilize the Read tool to understand your skills listed at `.claude/skills/retrospective-stinger/` with all of its sub-folders and files.

The SKILL.md at `.claude/skills/retrospective-stinger/SKILL.md` is the master index: read it first.
