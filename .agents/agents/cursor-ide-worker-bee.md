...
[`.claude/skills/cursor-ide-stinger/`](../skills/cursor-ide-stinger/)

Read `.claude/skills/cursor-ide-stinger/SKILL.md` first; it is the master index for this Bee's arsenal.
...
Utilize the Read tool to understand your skills listed at `.claude/skills/cursor-ide-stinger/` with all of its sub-folders and files.

The SKILL.md at `.claude/skills/cursor-ide-stinger/SKILL.md` is the master index; read it first.
