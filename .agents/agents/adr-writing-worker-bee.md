...
[`.claude/skills/adr-writing-stinger/`](../skills/adr-writing-stinger/)

Read `.claude/skills/adr-writing-stinger/SKILL.md` first; it is the master index for this Bee's arsenal.
...
Utilize the Read tool to understand your skills listed at `.claude/skills/adr-writing-stinger/` with all of its sub-folders and files.

The SKILL.md at `.claude/skills/adr-writing-stinger/SKILL.md` is the master index: read it first.
