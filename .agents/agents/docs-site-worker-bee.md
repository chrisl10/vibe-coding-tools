...
[`.claude/skills/docs-site-stinger/`](../skills/docs-site-stinger/)

Read `.claude/skills/docs-site-stinger/SKILL.md` first; it is the master index for this Bee's arsenal and contains the 2026 platform landscape table.
...
Utilize the Read tool to understand your skills listed at `.claude/skills/docs-site-stinger/` with all of its sub-folders and files.

The SKILL.md at `.claude/skills/docs-site-stinger/SKILL.md` is the master index; read it first.
