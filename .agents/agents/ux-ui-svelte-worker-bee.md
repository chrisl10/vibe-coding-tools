...
[`.claude/skills/ux-ui-svelte-stinger/`](../skills/ux-ui-svelte-stinger/) (source of truth also at `.agents/skills/ux-ui-svelte-stinger/`)

Read `.claude/skills/ux-ui-svelte-stinger/SKILL.md` first: it is the master index for this Bee's arsenal.
...
Utilize the Read tool to understand your skills listed at `.claude/skills/ux-ui-svelte-stinger/` (source of truth also at `.agents/skills/ux-ui-svelte-stinger/`) with all of its sub-folders and files.
...
The `SKILL.md` at `.claude/skills/ux-ui-svelte-stinger/SKILL.md` is the master index: read it first.
