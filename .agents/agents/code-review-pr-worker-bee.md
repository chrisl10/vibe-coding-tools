...
[`.claude/skills/code-review-pr-stinger/`](../skills/code-review-pr-stinger/)

Read `.claude/skills/code-review-pr-stinger/SKILL.md` first; it is the master index for this Bee's arsenal.
...
Utilize the Read tool to understand your skills listed at `.claude/skills/code-review-pr-stinger/` with all of its sub-folders and files.

The SKILL.md at `.claude/skills/code-review-pr-stinger/SKILL.md` is the master index: read it first.
