...
[`.claude/skills/terminal-bash-stinger/`](../skills/terminal-bash-stinger/)

Read `.claude/skills/terminal-bash-stinger/SKILL.md` first; it is the master index for this Bee's arsenal.
...
Utilize the Read tool to understand your skills listed at `.claude/skills/terminal-bash-stinger/` with all of its sub-folders and files.

The `SKILL.md` at `.claude/skills/terminal-bash-stinger/SKILL.md` is the master index: read it first.
