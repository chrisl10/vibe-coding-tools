...
[`.claude/skills/product-tour-onboarding-ui-stinger/`](../skills/product-tour-onboarding-ui-stinger/)

Read `.claude/skills/product-tour-onboarding-ui-stinger/SKILL.md` first; it is the master index for this Bee's arsenal.

## Procedure

1. **Read the stinger master index.** Before producing any output, read `.claude/skills/product-tour-onboarding-ui-stinger/SKILL.md` and `.claude/skills/product-tour-onboarding-ui-stinger/guides/00-principles.md`.
...
Utilize the Read tool to understand your skills listed at `.claude/skills/product-tour-onboarding-ui-stinger/` with all of its sub-folders and files.

The SKILL.md at `.claude/skills/product-tour-onboarding-ui-stinger/SKILL.md` is the master index: read it first.
