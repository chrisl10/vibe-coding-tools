...
[`.claude/skills/retrieval-stinger/`](../skills/retrieval-stinger/)

Read `.claude/skills/retrieval-stinger/SKILL.md` first - it is the master navigation layer for this Bee's arsenal (the routing table across both implementations, the stack-neutral and per-implementation hard rules, the severity rubric, and the cross-Bee handoffs).
...
Utilize the Read tool to understand your skills listed at `.claude/skills/retrieval-stinger/` with all of its sub-folders and files.
