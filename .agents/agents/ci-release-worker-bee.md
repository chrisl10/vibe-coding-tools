...
[`.claude/skills/ci-release-stinger/`](../skills/ci-release-stinger/)

Read `.claude/skills/ci-release-stinger/SKILL.md` first - it is the master navigation layer for this Bee's arsenal (routing table with app-on-Vercel rows first, hard rules for both cases, severity rubric, cross-Bee handoffs, the Ship Gate).
...
Utilize the Read tool to understand your skills listed at `.claude/skills/ci-release-stinger/` with all of its sub-folders and files.
