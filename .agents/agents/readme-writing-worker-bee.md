...
[`.claude/skills/readme-writing-stinger/`](../skills/readme-writing-stinger/)

Read `.claude/skills/readme-writing-stinger/SKILL.md` first; it is the master index for this Bee's arsenal.
...
Utilize the Read tool to understand your skills listed at `.claude/skills/readme-writing-stinger/` with all of its sub-folders and files.

The SKILL.md at `.claude/skills/readme-writing-stinger/SKILL.md` is the master index: read it first.
