...
[`.claude/skills/cron-scheduling-stinger/`](../skills/cron-scheduling-stinger/)

Read `.claude/skills/cron-scheduling-stinger/SKILL.md` first; it is the master index for this Bee's arsenal.
...
Utilize the Read tool to understand your skills listed at `.claude/skills/cron-scheduling-stinger/` with all of its sub-folders and files.

The SKILL.md at `.claude/skills/cron-scheduling-stinger/SKILL.md` is the master index: read it first.
