...
[`.claude/skills/sentry-stinger/`](../skills/sentry-stinger/)

Read `.claude/skills/sentry-stinger/SKILL.md` first - it is the master navigation layer for this Bee's arsenal (progressive-disclosure map, the known profiling-coverage gap, the Ship Gate).
