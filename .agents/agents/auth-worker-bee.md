...
[`.claude/skills/auth-stinger/`](../skills/auth-stinger/)

Read `.claude/skills/auth-stinger/SKILL.md` first: it is the master navigation layer for this Bee's arsenal (invocation modes, hard rules, severity rubric, cross-Bee handoffs).
...
Utilize the Read tool to understand your skills listed at `.claude/skills/auth-stinger/` with all of its sub-folders and files.
