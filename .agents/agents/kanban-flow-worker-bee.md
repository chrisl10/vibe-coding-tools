...
[`.claude/skills/kanban-flow-stinger/`](../skills/kanban-flow-stinger/)

Read `.claude/skills/kanban-flow-stinger/SKILL.md` first; it is the master index for this Bee's arsenal.
...
3. **Load the relevant guide** from `.claude/skills/kanban-flow-stinger/guides/`. The guide owns the procedure; this Bee delegates depth to the Stinger.
...
Utilize the Read tool to understand your skills listed at `.claude/skills/kanban-flow-stinger/` with all of its sub-folders and files.

The SKILL.md at `.claude/skills/kanban-flow-stinger/SKILL.md` is the master index: read it first.
