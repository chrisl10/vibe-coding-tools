...
[`.claude/skills/tailwind-stinger/`](../skills/tailwind-stinger/)

Read `.claude/skills/tailwind-stinger/SKILL.md` first, it is the master navigation layer for this Bee's arsenal (scope boundary, file map, guide index).
...
Utilize the Read tool to understand the skills listed at `.claude/skills/tailwind-stinger/` with all of its sub-folders and files.
