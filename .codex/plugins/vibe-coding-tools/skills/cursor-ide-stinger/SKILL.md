...
| Role | Artifact |
|---|---|
| This stinger | `.claude/skills/cursor-ide-stinger/` |
| Paired Bee | `.claude/agents/cursor-ide-worker-bee.md` |
| Harness Bee (other agents) | `.claude/agents/harness-integration-worker-bee.md` |
| MCP protocol Bee | `.claude/agents/mcp-protocol-worker-bee.md` |
