...
[`.claude/skills/mcp-protocol-stinger/`](../skills/mcp-protocol-stinger/)

Read `.claude/skills/mcp-protocol-stinger/SKILL.md` first; it is the master index for this Bee's arsenal.

## Procedure

1. **Read the stinger's principles guide first.** Open `.claude/skills/mcp-protocol-stinger/guides/00-principles.md` to orient on spec-first reasoning, tool idempotency + side-effect declaration, the tools/resources/prompts distinction, and JSON-RPC error-code honesty before making any ruling.
...
Utilize the Read tool to understand your skills listed at `.claude/skills/mcp-protocol-stinger/` with all of its sub-folders and files.

The SKILL.md at `.claude/skills/mcp-protocol-stinger/SKILL.md` is the master index - read it first.
