...
[`.claude/skills/branching-strategy-stinger/`](../skills/branching-strategy-stinger/)

Read `.claude/skills/branching-strategy-stinger/SKILL.md` first; it is the master index for this Bee's arsenal.
...
Utilize the Read tool to understand your skills listed at `.claude/skills/branching-strategy-stinger/` with all of its sub-folders and files.

The SKILL.md at `.claude/skills/branching-strategy-stinger/SKILL.md` is the master index: read it first.
