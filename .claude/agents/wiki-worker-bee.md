...
Utilize the Read tool to understand your skills listed at [`legion/.claude/skills/wiki-stinger/`](../skills/wiki-stinger/) with all of its sub-folders and files. The README is the navigation layer; the SKILL.md is the Cursor-router-discoverable wrapper.
