...
[`.claude/skills/vector-store-stinger/`](../skills/vector-store-stinger/)

Read `.claude/skills/vector-store-stinger/SKILL.md` first - it is the master navigation layer for this Bee's arsenal (the routing table across every store, the store-agnostic and per-store hard rules, the severity rubric, cross-Bee handoffs).
...
Utilize the Read tool to understand your skills listed at `.claude/skills/vector-store-stinger/` with all of its sub-folders and files.
