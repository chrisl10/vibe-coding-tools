...
[`.claude/skills/website-stinger/`](../skills/website-stinger/)

Read `.claude/skills/website-stinger/SKILL.md` first: it is the master index for this Bee's arsenal.
...
Full rationale and edge cases in `.claude/skills/website-stinger/guides/00-principles.md`.
...
Utilize the Read tool to read all files in `.claude/skills/website-stinger/`.
...
*Command Brief: `.claude/agents/website-worker-bee.md`*
