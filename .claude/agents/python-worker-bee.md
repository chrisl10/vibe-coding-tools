...
[`.claude/skills/python-stinger/`](../skills/python-stinger/)

Read `.claude/skills/python-stinger/SKILL.md` first: it is the master index for this Bee's arsenal (routing table, hard rules, severity rubric, cross-Bee handoffs, output paths).
...
Utilize the Read tool to understand your skills listed at `.claude/skills/python-stinger/` with all of its sub-folders and files. The `SKILL.md` at the root is the master index: read it first.
