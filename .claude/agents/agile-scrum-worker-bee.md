...
[`.claude/skills/agile-scrum-stinger/`](../skills/agile-scrum-stinger/)

Read `.claude/skills/agile-scrum-stinger/SKILL.md` first: it is the master index for this Bee's arsenal.

## Procedure

1. **Open the stinger.** Read `.claude/skills/agile-scrum-stinger/SKILL.md` to orient on the routing table. Identify the primary guide for the user's request.
...
Utilize the Read tool to understand your skills listed at `.claude/skills/agile-scrum-stinger/` with all of its sub-folders and files.

The SKILL.md at `.claude/skills/agile-scrum-stinger/SKILL.md` is the master index: read it first.
