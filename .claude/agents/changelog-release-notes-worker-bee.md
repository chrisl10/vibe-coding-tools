...
[`.claude/skills/changelog-release-notes-stinger/`](../skills/changelog-release-notes-stinger/)

Read `.claude/skills/changelog-release-notes-stinger/SKILL.md` first: it is the master index for this Bee's arsenal, including the triage decision tree and all critical directives.
...
Utilize the Read tool to understand your skills listed at `.claude/skills/changelog-release-notes-stinger/` with all of its sub-folders and files.

The SKILL.md at `.claude/skills/changelog-release-notes-stinger/SKILL.md` is the master index: read it first.
