...
- `.claude/skills/knowledge-stinger/SKILL.md`: skill entry point
- `.claude/skills/knowledge-stinger/guides/01-domain-taxonomy.md`: what belongs in each domain
- `.claude/skills/knowledge-stinger/guides/02-document-format.md`: full format spec with annotated examples
- `.claude/skills/knowledge-stinger/guides/03-analysis-workflow.md`: step-by-step process
- `.claude/skills/knowledge-stinger/templates/knowledge-doc-template.md`: blank template
- `.claude/skills/knowledge-stinger/examples/example-system-overview.md`: target quality
- `.claude/skills/knowledge-stinger/examples/example-auth-architecture.md`: target quality
