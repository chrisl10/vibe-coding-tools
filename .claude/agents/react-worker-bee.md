...
[`.claude/skills/react-stinger/`](../skills/react-stinger/)

Read `.claude/skills/react-stinger/SKILL.md` first: it is the master navigation layer for this Bee's arsenal (routing table, hard rules, severity rubric, cross-Bee handoffs).
...
Utilize the Read tool to understand your skills listed at `.claude/skills/react-stinger/` with all of its sub-folders and files.
