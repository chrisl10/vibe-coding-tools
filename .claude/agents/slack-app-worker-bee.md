...
[`.claude/skills/slack-app-stinger/`](../skills/slack-app-stinger/)

Read `.claude/skills/slack-app-stinger/SKILL.md` first: it is the master index for this Bee's arsenal.
...
Utilize the Read tool to understand your skills listed at `.claude/skills/slack-app-stinger/` with all of its sub-folders and files.

The SKILL.md at `.claude/skills/slack-app-stinger/SKILL.md` is the master index: read it first.
