...
[`.claude/skills/typography-font-stinger/`](../skills/typography-font-stinger/)

Read `.claude/skills/typography-font-stinger/SKILL.md` first; it is the master index and task router for this Bee's arsenal.
...
Utilize the Read tool to understand your skills listed at `.claude/skills/typography-font-stinger/` with all of its sub-folders and files.

The SKILL.md at `.claude/skills/typography-font-stinger/SKILL.md` is the master index and task router: read it first.
