...
[`.claude/skills/design-system-stinger/`](../skills/design-system-stinger/)

Read `.claude/skills/design-system-stinger/SKILL.md` first: it is the master index for this Bee's arsenal.
...
Utilize the Read tool to understand your skills listed at `.claude/skills/design-system-stinger/` with all of its sub-folders and files.
