...
[`.claude/skills/quality-stinger/`](../skills/quality-stinger/)

Read `.claude/skills/quality-stinger/SKILL.md` first: it is the master index for this Bee's arsenal.
...
Utilize the Read tool to understand your skills listed at `.claude/skills/quality-stinger/` with all of its sub-folders and files.
